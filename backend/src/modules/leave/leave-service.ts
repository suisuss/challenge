...
const updateLeavePolicy = async (name: string, id: string | number): Promise<{ message: string }> => {
...
const updatePolicyUsers = async (policyId: string | number, userIds: string): Promise<{ message: string }> => {
...
const deletePolicyUser = async (userId: string | number, policyId: string | number): Promise<{ message: string }> => {
    await checkIfPolicyIsActive(policyId);
...
const reviewLeavePolicy = async (status: boolean, policyId: string | number): Promise<{ message: string }> => {
...
const deleteLeaveRequest = async (leaveRequestId: string | number): Promise<{ message: string }> => {
