...
export const handleAccountEmailVerify = asyncHandler(
  async (req: Request, res: Response): Promise<void> => {
    const { id } = req.user!;
...
export const handleAccountPasswordSetup = asyncHandler(
  async (req: Request, res: Response): Promise<void> => {
...
export const handleResendEmailVerification = asyncHandler(
  async (req: Request, res: Response): Promise<void> => {
...
export const handleResendPwdSetupLink = asyncHandler(
  async (req: Request, res: Response): Promise<void> => {
    const { userId } = req.body;
