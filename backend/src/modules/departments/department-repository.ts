...
const getDepartmentById = async (id: string | number): Promise<any> => {
...
const updateDepartmentById = async (payload: { id: string | number; name: string }): Promise<number> => {
...
const deleteDepartmentById = async (id: string | number): Promise<number> => {
