...
const checkIfRoleIdExist = async (id: string | number): Promise<void> => {
...
const fetchRole = async (id: string | number): Promise<any> => {
...
const updateRole = async (id: string | number, name: string): Promise<{ message: string }> => {
    await checkIfRoleIdExist(id);
...
const processRoleStatus = async (id: string | number, status: boolean): Promise<{ message: string }> => {
    await checkIfRoleIdExist(id);
...
const addRolePermission = async (roleId: string | number, permissionIds: string): Promise<{ message: string }> => {
...
const getRolePermissions = async (roleId: string | number): Promise<any[]> => {
    await checkIfRoleIdExist(roleId);
...
const fetchUsersByRoleId = async (id: string | number): Promise<any[]> => {
    await checkIfRoleIdExist(id);
...
const processSwitchRole = async (userId: string | number, newRoleId: string | number): Promise<{ message: string }> => {
