...
const processGetNoticeRecipient = async (id: string | number): Promise<any> => {
...
const fetchNoticeDetailById = async (id: string | number): Promise<any> => {
...
const processDeleteNoticeRecipient = async (id: string | number): Promise<{ message: string }> => {
