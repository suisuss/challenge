...
const getSectionById = async (id: string | number): Promise<any> => {
...
const deleteSectionById = async (id: string | number): Promise<number> => {
...
export { getAllSections, getSectionById, updateSectionById, deleteSectionById, addNewSection };
